...
novel_mul = [
    {
        ...
        "query": "halo bro, tolong compare dong biological findings di paper 1 sama paper 2: mekanisme kerjanya apa aja dan kesimpulan akhirnya gimana? ringkas aja",
    ...
    },
    {
        ...
        "query": "aduh saya bingung banget, bisa tolong jelasin pake bahasa sederhana gak perbedaan metode adaptasi domain antara paper [1] dan paper [2]?",
        "target_documents": ["qasper_1801.05147.txt", "qasper_1805.02400.txt"],
        "documents": ["qasper_1801.05147.txt", "qasper_1805.02400.txt"],
        "ground_truth": "Paper [1] mengusulkan metode adaptasi domain berbasis representasi fitur, sedangkan Paper [2] berfokus pada pemodelan urutan teks dan transfer learning dengan konfigurasi baseline yang berbeda.",
        "unanswerable": False
    },
    {
        "id": "MUL-25",
...
novel_unans = [
    {
        ...
        "persona": "casual_slang",
        "query": "bro ada gak info berapa total biaya tagihan AWS cloud compute yg dihabiskan penulis selama training model ini?",
    ...
    },
    {
        ...
        "category": "negative_unanswerable",
        "persona": "confused_beginner",
        "query": "saya baru belajar machine learning, di paper ini ada tutorial langkah demi langkah cara install pytorch di windows 11 gak ya?",
    ...
    },
    {
        ...
        "category": "negative_unanswerable",
        "persona": "casual_slang",
        "query": "eh min, model ini katanya pernah ditest di dataset bahasa Jawa gak? penasaran akurasinya brp",
        "target_documents": ["qasper_1811.00383.txt"],
        "documents": ["qasper_1811.00383.txt"],
        "ground_truth": "Unanswerable. Penelitian ini tidak mengevaluasi atau menyebutkan dataset bahasa Jawa.",
        "unanswerable": True
    },
    {
        "id": "UNANS-20",
    ...
    },
    {
        ...
        "category": "negative_unanswerable",
        "persona": "confused_beginner",
        "query": "tolong carikan link google drive buat download pre-trained weights model ini dong min, saya cari di githubnya gak nemu",
        "target_documents": ["qasper_1905.00840.txt"],
        "documents": ["qasper_1905.00840.txt"],
        "ground_truth": "Unanswerable. Dokumen tidak menyediakan link Google Drive untuk mengunduh bobot model.",
        "unanswerable": True
    },
    {
        "id": "UNANS-23",
