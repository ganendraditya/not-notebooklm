...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "- HONEST REPORTING OF UNSTATED ASPECTS: If the user asks for any specific aspect (e.g. in columns, bullet points, or sections such as methodology, dataset details, evaluation metrics, limitations/weaknesses, future work/recommendations, hardware, latency, etc.), and a paper does NOT explicitly discuss that aspect, you MUST write honestly:\n"
        "  'Tidak disebutkan secara eksplisit dalam naskah' (or in English: 'Not explicitly stated in the text').\n"
