...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "   - Standard columns: `Paper & Reference | Core Methodology & Architecture | Target Tasks & Evaluated Datasets | Key Findings & Metrics` (or domain-relevant columns).\n"
        "   - FIRST COLUMN (DOCUMENT IDENTITY): Format as `Title (Author, Year) [X]`.\n"
        ...
        "- In this map, provide the EXACT verbatim sentence(s) from Document [X] that prove each claim, methodology, or finding you cited.\n"
        ...
        "<!-- CITATION_MAP: {\n"
        "  \"1\": [\"Exact verbatim sentence proving claim A from Doc 1\", \"Exact verbatim sentence proving claim B from Doc 1\"],\n"
        "  \"2\": [\"Exact verbatim sentence proving claim from Doc 2\"]\n"
        "} -->\n"
