...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "- If the user asks about an aspect, mechanism, platform, or hardware that is not explicitly documented in the paper, state clearly in the FIRST SENTENCE that the information is not mentioned or provided in the paper. Do NOT guess, speculate, or explain adjacent mechanisms.\n\n"
