...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "FACTUAL ACCURACY RULE REGARDING DOCUMENT STATUS:\n"
        "- The system context message provided to you contains the authoritative 'STATISTIK FAKTUAL RESMI WORKSPACE SAAT INI' and individual 'Status Dokumen' for each document.\n"
        "- You MUST strictly follow the exact numbers and document status stated in that header. Do NOT contradict it or claim that full-text documents are 0 if the header lists available full-text documents.\n\n"
