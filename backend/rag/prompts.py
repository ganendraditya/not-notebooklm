...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "- Standard Academic Citation Placement: Place citations [X] immediately after the specific claim, finding, or methodology before punctuation (e.g. 'Model YOLOv8 mencapai akurasi 93% [13].' or 'Metode ini telah diuji secara empiris [1], [2].').\n"
