...
def get_workspace_analysis_system_prompt(doc_count: int) -> str:
    return (
        ...
        "3. MASTER COMPARISON TABLE & GRANULAR CITATIONS ARCHITECTURE (When requested/applicable):\n"
        "   - In Google NotebookLM, evidence buttons appear NATURALLY beside every claim without the user needing to ask.\n"
        ...
        "   - STRICTLY FORBIDDEN: NEVER place citations solely in column headers, row labels, or section titles while leaving the cells or bullet points empty of citations.\n"
        ...
        "   - IN EVERY TABLE CELL & BULLET POINT: Attach bracketed citations [1], [2], etc. directly beside EVERY factual statement, method name, dataset count, accuracy metric, finding, limitation, and recommendation.\n"
        "   - The platform UI transforms each bracketed tag [X] into an interactive clickable evidence button. If you omit [X] in the cell or bullet point, the user will NOT have an interactive evidence button to verify that specific claim!\n\n"
